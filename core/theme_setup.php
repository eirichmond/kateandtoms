...
function geebee_scripts() {
	...
	if ( ! is_page( 'syncipro' ) && ! is_page( 'syncipro-update-rates' ) ) {
		...
		wp_enqueue_script(
			'kandt-sidebar',
			get_template_directory_uri() . '/js/sidebarEffects.js',
			array(),
			date( 'Y-m' ),
			array(
				'in_footer' => true,
		...
		wp_enqueue_script(
			'kandt-cycle2',
			get_template_directory_uri() . '/js/cycle2.js',
			array( 'jquery' ),
			date( 'Y-m' ),
			array(
				'in_footer' => true,
		...
		wp_enqueue_script(
			'kandt-cycle-slider',
			get_template_directory_uri() . '/js/cycle-slider.js',
			array( 'jquery' ),
			date( 'Y-m' ),
			array(
				'in_footer' => true,
		...
		wp_enqueue_script(
			'kandt-katheader',
			get_template_directory_uri() . '/js/katHeader.jquery.js',
			array( 'jquery' ),
			date( 'Y-m' ),
			array(
				'in_footer' => true,
		...
		wp_localize_script(
			...
			array(
				...
				'nextNonce' => wp_create_nonce( 'kt-search-nonce' ),
			)
		);
...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$fields = array(
		array(
			'id'   => 'offer_period_identitfier',
			'type' => 'text',
			'cols' => 1,
		),
		array(
			'id'   => 'offer_period_name',
			'type' => 'text',
			'cols' => 2,
		),
		...
		array(
			'id'   => 'offer_details_bc_only',
			'desc' => 'offer details (BC only)',
			'type' => 'text',
			'cols' => 2,
		),
	...
	*/
	...
	$settings = array(
		...
		array(
			'id'   => 'show_associated_houses',
			'name' => 'Enable',
			'type' => 'checkbox',
		),
		array(
			'id'       => 'ah_from_features',
			'name'     => 'Feature includes',
			'type'     => 'taxonomy_select',
			'taxonomy' => 'feature',
			'multiple' => true,
		),
		array(
			'id'       => 'ah_from_locations',
		...
		array(
			'id'   => 'ah_section_cotswolds',
			'name' => 'Section Cotswolds',
			'type' => 'checkbox',
		),
		array(
			'id'   => 'ah_section_coast',
...
function posts_metaboxes( array $meta_boxes ) {
	...
	$fields = array(
		...
		array(
			'id'       => 'core-color',
			'name'     => 'Select Core Background Color',
			'type'     => 'radio',
			'options'  => $colors,
			'multiple' => false,
		),
