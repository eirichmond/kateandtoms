				...
				<div class="span3 litepanel color6 mini-logo">
					...
					<!-- 	<h1 class="page-title"><?php echo '<a href="/houses/' . $house->getName() . '/'.$preview.'">' . get_the_title() . '</a>'; ?></h1> -->
						...
						<div class="house_page_meta">
							...
							<span class="house_page_meta_single"><!-- <i class="icon-home"></i>  --><?php echo $berth.' ' . get_post_meta($the_query->post->ID, 'sleeps_min', true); ?>-<?php echo get_post_meta($the_query->post->ID, 'sleeps_max', true); ?></span>
